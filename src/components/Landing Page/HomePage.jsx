...
export default function HomePage() {
  ...
  return (
    <Box m={"2% 0"} height={"100%"}>
      ...
      <br />
      <Typography variant="h4" textAlign={"left"} m={"0 5%"}>Customer Stories</Typography>
      ...
      <CustomerStories items={[
  {
    ...
    review: "Awesome Service. lorem loremloremloremlorem lorem lorem lorem lorem loremv v  lorem loremloremloremlorem lorem lorem lorem lorem loremv v  lorem loremloremloremlorem lorem lorem lorem lorem loremv v",
    rating: "5 Stars",
  },
  {
    name: "Ishan Yadav",
    ...
    review: "Best Quality.  lorem loremloremloremlorem lorem lorem lorem lorem loremv v  lorem loremloremloremlorem lorem lorem lorem lorem loremv v  lorem loremloremloremlorem lorem lorem lorem lorem loremv v",
    rating: "5 Stars",
  },
  {
    name: "Aayush Rathore",
    ...
    review: "Will Refer it to others.  lorem loremloremloremlorem lorem lorem lorem lorem loremv v  lorem loremloremloremlorem lorem lorem lorem lorem loremv v  lorem loremloremloremlorem lorem lorem lorem lorem loremv v",
    rating: "5 Stars",
  },
]} />
      <CustomerStories items={[
  {
    ...
    work:"Software Engineer",
    img:"https://avatars.githubusercontent.com/u/34219384?s=100&v=4",
    review: "Awesome Service. lorem loremloremloremlorem lorem lorem lorem lorem loremv v  lorem loremloremloremlorem lorem lorem lorem lorem loremv v  lorem loremloremloremlorem lorem lorem lorem lorem loremv v",
    rating: "5 Stars",
  },
  {
